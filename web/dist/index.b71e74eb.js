...
parcelHelpers.export(exports, "User", ()=>User) // note: for the on method, I think what we are trying to do is to create and store all the possible list of events that this project can have and then be able to call those methods at at future point in time.
...
class User {
    events = new (0, _eventing.Eventing)() // this event class would be on every instance created by default but we wont be swapping it out so it is the best approach
    ;
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Sync", ()=>Sync) // 'JetBrains Mono medium'
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["17ZdQ","h7u1C"], "h7u1C", "parcelRequire2d1f")
